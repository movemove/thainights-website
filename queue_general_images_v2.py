...
# EXACT JSON TEMPLATE from Kevin's message (7744)
WORKFLOW_TEMPLATE = {
...
def queue_jobs():
    print("🚀 Queuing 'General Guide' images with strict JSON matching...")
    for name, prompt in JOBS:
        print(f"Queuing: {name}...")
        for i in range(1, 3):
            # Use JSON string round-trip for true deep copy
